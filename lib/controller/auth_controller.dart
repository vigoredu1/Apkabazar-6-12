...
import 'package:quickad_it_solutions/data/model/body/delivery_man_body.dart';
import 'package:quickad_it_solutions/data/model/body/store_body.dart';
...
import 'package:quickad_it_solutions/data/model/response/delivery_man_vehicles.dart';
...
import 'package:quickad_it_solutions/data/model/response/zone_model.dart';
...
class AuthController extends GetxController implements GetxService {
  ...
  Future<ResponseModel?> login(String? phone) async {
    ...
    if (response.statusCode == 200) {
      ...
      Get.offNamed(RouteHelper.getSignUpRoute(phone!));
    } else {
      responseModel = ResponseModel(false, response.statusText);
    }
    _isLoading = false;
